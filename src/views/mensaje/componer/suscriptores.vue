...
// error during build:
// src / views / sms / componer / suscriptores.vue(12: 9): "useGruposNotificadosStore" is not exported by "src/stores/notificados/index.js", imported by "src/views/sms/componer/suscriptores.vue".
