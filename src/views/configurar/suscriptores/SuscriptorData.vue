...
// error during build:
// [vite: load - fallback] Could not load D: \proyectos\vue - bs\sms\src / stores / config - suscriptores(imported by src / views / configurar / suscriptores / SuscriptorData.vue): ENOENT: no such file or directory, open 'D:\proyectos\vue-bs\sms\src\stores\config-suscriptores'
